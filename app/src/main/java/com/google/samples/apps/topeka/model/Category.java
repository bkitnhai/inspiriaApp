...
public class Category implements Parcelable {
    ...
    public Category(@NonNull String name, @NonNull String id, @NonNull List<String>  mac, @NonNull Theme theme,
    ...
    public Category(String name, String id, List<String> mac, Theme theme, List<Quiz> quizzes, int[] scores,
                    boolean solved) {
        mName = name;
        mId = id;
