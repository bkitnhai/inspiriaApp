...
public class CategoryAdapter extends BaseAdapter {
    ...
    public CategoryAdapter(Activity activity) throws JSONException {
...
To use something other than TextViews for the array display, for instance, ImageViews,
 or to have some of data besides toString() results fill the views, override getView(int, View, ViewGroup) to return the type of view you want.
 */
    @Override
    ...
    private void setCategoryIcon(Category category, ImageView icon) {
        Log.i("selectIcOn 1",ICON_CATEGORY + category.getId()) ;
        Log.i("selectIcOn 2",DRAWABLE) ;
        Log.i("selectIcOn 3",mPackageName) ;
    ...
    private void updateCategories(Activity activity) throws JSONException {
