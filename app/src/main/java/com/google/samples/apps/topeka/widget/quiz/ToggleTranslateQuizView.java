...
public class ToggleTranslateQuizView extends AbsQuizView<ToggleTranslateQuiz> {
    ...
    public ToggleTranslateQuizView(Context context, Category category, ToggleTranslateQuiz quiz,int mac) {
        super(context, category, quiz, mac);
        mAnswers = new boolean[quiz.getOptions().length];
        _("ToggleTranslateQuizView");
    }
    ...
    public void _(String s){
        Log.i("MyApp", "ToggleTranslateQuizView" + "#######" + s);
    }
}
