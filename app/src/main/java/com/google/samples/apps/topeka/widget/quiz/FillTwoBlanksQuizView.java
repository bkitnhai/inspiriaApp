...
public class FillTwoBlanksQuizView extends TextInputQuizView<FillTwoBlanksQuiz> {
    ...
    public FillTwoBlanksQuizView(Context context, Category category, FillTwoBlanksQuiz quiz, int mac) {
        super(context, category, quiz,mac);
        _("FillTwoBlanksQuizView");
    }
    ...
    public void _(String s){
        Log.i("MyApp", "FillTwoBlanksQuizView" + "#######" + s);
    }
}
